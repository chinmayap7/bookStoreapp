...
function Login() {
  ...
  <div className="modal-box">
    ...
    <div className='mt-4 space-y-2 py-1'>
        ...
        {errors.email && <span className="text-red-500">Email is required</span>}   {/* on chatGPT */}
    </div>
    ...
    <div className='mt-4 space-y-2 py-1'>
        ...
        {errors.password && <span className="text-red-500">Password is required</span>} {/*on ChatGPT */}
    </div>
